...
from NationalParkEntranceFee.items import NPEntranceFeeItem
...
class NPEntranceFeeSpider(Spider):
	name = "np_entrancefee_spider"
	allowed_urls = ['https://www.nps.gov']
	start_urls = ['https://www.nps.gov/aboutus/entrance-fee-prices.htm']

	def parse(self, response):
		part = response.xpath('//div[@class="Component text-content-size text-content-style ArticleTextGroup clearfix"]')
		park_name_list = []
		park_info_list = []
